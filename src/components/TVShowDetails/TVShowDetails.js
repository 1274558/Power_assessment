                    ...
                    <div className="Detailscontainer col-xs-8 col-md-7 col-lg-8">
                        ...
                        <div className="Infocontainer">
                            <div className="Additionalinfo">
                                <div className="info-text-block"><b>Show type: </b> {this.props.showtype}</div>
                                <div className="info-text-block"><b>Genres: </b> {this.props.showgenres[0]}, {this.props.showgenres[1]}, {this.props.showgenres[2]}</div>
                                <div className="info-text-block"><b>Premiered: </b> {this.props.showpremiered}</div>
                                <div className="info-text-block"><b>Rating: </b>{this.props.showrating}</div>
                            </div>
